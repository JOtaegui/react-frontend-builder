...
export function AppSidebar() {
  ...
  const resultItems = id
    ? [
        { title: "Resultados", url: `/resultados/${id}`, icon: BarChart3 },
        { title: "Hallazgos", url: `/hallazgos/${id}`, icon: FileSearch },
        { title: "Plan de Acción", url: `/plan/${id}`, icon: ClipboardCheck },
      ]
    : [];
